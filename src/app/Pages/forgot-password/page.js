    ...
    return (
        ...
        <div className="forgot-wrapper">
            ...
            <div className="right-panel d-flex align-items-center justify-content-center p-4">
                <div className="auth-box p-5 rounded-4 glass shadow-lg">
                    ...
                    {step === 4 && (
                        <div className="text-center mt-3">
                            Password reset successful! <Link href="/pages/login" className="text-primary fw-semibold text-decoration-none">Login Now</Link>
                        </div>
                    )}
                </div>
            </div>
